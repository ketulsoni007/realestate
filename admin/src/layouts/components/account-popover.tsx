...
import { authLogoutApi } from 'src/store/Slices/authSlice';
import { persistor, useAppDispatch } from 'src/store';
// ----------------------------------------------------------------------
      ...
      >
        <Box sx={{ p: 2, pb: 1.5 }}>
          ...
          <Typography
            ...
            sx={(theme) => ({
              ...textGradient(
                `to right, ${theme.vars.palette.error.main}, ${theme.vars.palette.warning.main}`
              ),
            })}
          >
            {user?.role?.purpose}
