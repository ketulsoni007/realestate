...
import { permissionListApi, sidebarApi } from 'src/store/Slices/commonSlice';
...
export function OverviewAnalyticsView() {
  const canViewDashboard = userPermissionCheck('Dashboard', 'can_view');
  ...
  const sidebarList = useAppSelector((state)=>state.common.isSideBarList);
