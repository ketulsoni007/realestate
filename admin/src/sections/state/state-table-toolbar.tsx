...
import { stateDeleteApi, stateListApi } from 'src/store/Slices/stateSlice';
          ...
          <IconButton
            onClick={() => {
              showConfirmation({
                ...
                if (result) {
                  dispatch(stateDeleteApi({ ids: selected })).then((action) => {
                    if (action?.meta?.requestStatus === 'fulfilled') {
                      dispatch(stateListApi({ page: page, rowsPerPage: rowsPerPage }));
                      table.setSelected([]);
                      toastNotificationAdmin.success('State deleted successfully');
