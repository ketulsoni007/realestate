    ...
    <div className="py-16">
      ...
      <div className="grid grid-cols-1 gap-4 mt-5 sm:grid-cols-2 md:grid-cols-3">
        {focus.map(({ id, name, icon, text }) => (
          <div
            className="relative p-3 text-center rounded-lg border-t-4 border-transparent group hover:card-shadow hover:border-t-primary dark:hover:bg-card-dark"
            key={id}
          >
            ...
            <div className="mt-4 opacity-0 visibility-hidden transition-all duration-300 group-hover:opacity-100 group-hover:visibility-visible flex justify-center">
