...
// ['House', 'Apartment', 'Commercial', 'Land','Office','Villa']
...
export const focus = [
  {
    ...
    name: "Buy a New Home",
    icon: <BiHomeAlt />,
    text: "Discover your ideal home from our extensive listings. Whether you’re looking for a family residence, a modern apartment, or an investment property, our experts will help you find a place that truly feels like home.",
  },
  {
    id: 2,
    name: "Sell a Home",
    icon: <BiMoney />,
    text: "Unlock the true potential of your property. Our dedicated team will ensure you get the best value through tailored marketing strategies, connecting you with serious buyers who see the value in your home.",
  },
  {
    id: 4,
    name: "Rent a Home",
    icon: <BiBuildings />,
    text: "Find rental properties that suit your lifestyle and budget. From short-term leases to long-term homes, we offer flexible options in sought-after locations to give you the comfort and convenience you deserve.",
  },
];
